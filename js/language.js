...
var ja = {    
    ...
    "modalText": "Get Seatedにご興味をお持ち頂きありがうございます！Get Seatedはまだ開発段階のアプリですが、ローンチの際には、いち早くお知らせさせて頂きます。それまでの間、皆様からフィードバックを頂戴し、アプリの開発に活かしたいと考えています。もし、意見をご提供頂けるようでしたら、下記フォームより、メールアドレスをお送りください。お送り頂きましたいただいたメールアドレスは、あなたからフィードバックを頂戴する目的でのみ利用し、スパム行為や第三者への共有は一切致しません。",
